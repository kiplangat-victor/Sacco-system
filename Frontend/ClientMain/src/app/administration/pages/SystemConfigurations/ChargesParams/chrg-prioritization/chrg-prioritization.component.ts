...
@Component({
  ...
  templateUrl: './chrg-prioritization.component.html',
  styleUrls: ['./chrg-prioritization.component.scss']
})
export class ChrgPrioritizationComponent implements OnInit {
  ...
  constructor(
    ...
    // if selected, then disabled it.
// controllData(){
// const priorities: string[] = ['Customer Level','Account Level','Charge Level','Contract Level'];
// priorities.remove()
// }

prioritiesArray = this.onSelectPriority(event);
