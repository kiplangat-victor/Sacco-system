...
public class EntityBranchController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addEntityBranch(@RequestBody SEntityBranch SEntityBranch, @RequestParam Long fk_id) {
        try {
            return ResponseEntity.ok().body(entityBranchService.addEntityBranch(SEntityBranch, fk_id));
        } catch (Exception e) {
    ...
    @PutMapping("/modify")
    public ResponseEntity<?> modifyEntityBranch(@RequestBody SEntityBranch SEntityBranch) {
        try {
            return ResponseEntity.ok().body(entityBranchService.modifyEntityBranch(SEntityBranch));
        } catch (Exception e) {
            log.info("Catched Error {} " + e);
            return null;
        }
