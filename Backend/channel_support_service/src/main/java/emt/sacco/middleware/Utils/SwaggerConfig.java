package emt.sacco.middleware.Utils;//package emt.sacco.middleware.Utils;
//
...
//        return new ApiInfo("E&M MIDDLEWARE APPLICATION",
//                "Comprehensive Middleware Application for Sacco Switch Solution",
//                "1.0",
//                "Terms of service",
...
//                        .description("Remote User").in(ParameterType.HEADER).required(false)
...
//                        .description("Entity ID").in(ParameterType.HEADER).required(false)
//                        .query(simpleParameterSpecificationBuilder -> simpleParameterSpecificationBuilder
//                                .allowEmptyValue(true).model(modelSpecificationBuilder -> modelSpecificationBuilder
//                                        .scalarModel(ScalarType.STRING)))
//                        .build()));
