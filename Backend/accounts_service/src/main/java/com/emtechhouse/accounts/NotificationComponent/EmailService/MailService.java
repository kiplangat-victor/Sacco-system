package com.emtechhouse.accounts.NotificationComponent.EmailService;
...
public class MailService {
    ...
    @Value("${spring.application.enableProdMail}")
    private String enableProdMail;
    @Value("${spring.application.testMail}")
    ...
    public void sendEmail(String to, String subject, String message) throws MessagingException {
        String toEmail = to;
        if (enableProdMail.equalsIgnoreCase("false")){
            toEmail = testMail;
        }
        if ( enableEmail.equalsIgnoreCase("false")){
            System.out.println("----------------------------------------------------------------");
            System.out.println("Email is blocked! Check application.yml");
        }else{
            System.out.println("----------------------------------------------------------------");
