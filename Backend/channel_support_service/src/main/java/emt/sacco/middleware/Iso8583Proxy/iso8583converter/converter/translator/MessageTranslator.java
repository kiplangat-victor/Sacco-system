package emt.sacco.middleware.Iso8583Proxy.iso8583converter.converter.translator;

import emt.sacco.middleware.Iso8583Proxy.iso8583converter.converter.utility.Utility;
import emt.sacco.middleware.Iso8583Proxy.iso8583converter.org.json.JSONArray;
import emt.sacco.middleware.Iso8583Proxy.iso8583converter.org.json.JSONException;
...
public class MessageTranslator extends Translator{
	...
	{
		System.out.println("HERE IS THE FORMAT JSON MAP "+this.arrayToObject(formatMap)+"------------->>>>>");
