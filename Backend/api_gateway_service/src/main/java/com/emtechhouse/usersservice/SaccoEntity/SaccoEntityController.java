...
public class SaccoEntityController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addSaccoEntity(@RequestBody SaccoEntity saccoEntity) {
        try {
            return ResponseEntity.ok().body(saccoEntityService.addSaccoEntity(saccoEntity));
        } catch (Exception e) {
    ...
    @PutMapping("/modify")
    public ResponseEntity<?> modifySaccoEntity(@RequestBody SaccoEntity saccoEntity) {
        try {
            return ResponseEntity.ok().body(saccoEntityService.modifySaccoEntity(saccoEntity));
        } catch (Exception e) {
            log.info("Catched Error {} " + e);
            return null;
        }
