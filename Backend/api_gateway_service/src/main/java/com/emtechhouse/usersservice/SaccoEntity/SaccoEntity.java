...
import com.emtechhouse.usersservice.EntityBranch.EntityBranch;
...
//    }
    ...
    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "saccoEntity")
//    @JsonIgnore
    private List<EntityBranch> entityBranches;
    //*****************Operational Audit *********************
