...
export class SchemeTypeService {
  ...
  baseURL = `${environment.systemConfigAPI}/scheme-type`;
  ...
  // Get by id
  getSchemetypeId(id: any): Observable<any> {
  ...
  updateSchemetype(id: string | null, data: any): Observable<any> {
  ...
  deleteSchemetype(id: any): Observable<any> {
