...
@Component({
  selector: 'app-loans-accounts-look-up',
  templateUrl: './loans-accounts-look-up.component.html',
  styleUrls: ['./loans-accounts-look-up.component.scss']
})
export class LoansAccountsLookUpComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LoansAccountsLookUpComponent>
  ) { }
